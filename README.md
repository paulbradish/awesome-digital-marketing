...
- [StackData](https://greg-rg-git.github.io/stackdata-store/) - Structured pricing datasets for 13+ B2B SaaS categories (CRM, email marketing, devtools, PM tools, AI/ML tools, accounting, and more). Useful for competitive pricing benchmarks when you want raw data rather than a platform subscription.
